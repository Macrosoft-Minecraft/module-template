...
public class CloudScriptedIteratorTileEntities extends AbstractEntitiesIterator {
	...
	public CloudScriptedIteratorTileEntities(IScriptActionProvider provider, IMacro macro) {
	...
	@Override
    public void onInit() {
        ScriptContext.MAIN.getCore().registerIterator("tileentities", this.getClass());
    }
}